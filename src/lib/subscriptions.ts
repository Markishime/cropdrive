...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      'AI Agronomic Report',
      'Clarification Support Messages: 3 per month',
      'Standard Response Time',
      '5% Renewal Discount',
    ],
    featuresMs: [
      'Laporan Agronomi AI',
      'Mesej Sokongan Penjelasan: 3 sebulan',
  ...
  },
  {
    ...
    features: [
      'AI Agronomic Report',
      'Clarification Support Messages: 5 per month',
    ...
    featuresMs: [
      'Laporan Agronomi AI',
      'Mesej Sokongan Penjelasan: 5 sebulan',
      'Masa Respons 24 jam',
  ...
  },
  {
    ...
    features: [
      'AI Agronomic Report',
      'Clarification Support Messages: Unlimited',
      ...
      'Consult a Human Agronomist',
    ],
    featuresMs: [
      'Laporan Agronomi AI',
      'Mesej Sokongan Penjelasan: Tanpa Had',
      'Masa Respons 12 jam',
      '15% Diskaun Pembaharuan',
      '10% Bonus Rujukan',
      'Analisis Perbandingan',
      'Diskaun Rakan Kongsi',
      'Akses Eksklusif kepada Ciri AI Baharu',
      'Rujuk Agronomis Manusia',
    ],
