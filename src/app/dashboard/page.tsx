          ...
          {showNotifications && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-20 right-4 md:right-8 w-full max-w-md bg-white rounded-2xl shadow-2xl z-50 border-2 border-gray-200 overflow-hidden"
              >
                {/* Dropdown Header */}
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4">
                  ...
                  <p className="text-blue-100 text-xs mt-1">
                    {language === 'ms' ? '3 pemberitahuan baharu' : '3 new notifications'}
                  </p>
                </div>
                ...
                <div className="max-h-[70vh] overflow-y-auto">
                  <div className="p-3 space-y-2">
                    <motion.div
                      ...
                      className="flex items-start gap-3 p-3 bg-blue-50 border border-blue-200 rounded-xl hover:bg-blue-100 transition-all cursor-pointer"
                    >
                    ...
                    <motion.div
                      ...
                      className="flex items-start gap-3 p-3 bg-green-50 border border-green-200 rounded-xl hover:bg-green-100 transition-all cursor-pointer"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <button 
                          ...
                          className="text-xs text-green-700 font-bold mt-2 hover:underline"
                        >
                    ...
                    <motion.div
                      ...
                      className="flex items-start gap-3 p-3 bg-yellow-50 border border-yellow-200 rounded-xl hover:bg-yellow-100 transition-all cursor-pointer"
                    >
                  ...
                  <div className="border-t border-gray-200 p-3">
                    <button
                      onClick={() => setShowNotifications(false)}
                      className="w-full text-center text-sm font-bold text-blue-600 hover:text-blue-700 py-2 hover:bg-blue-50 rounded-lg transition"
                    >
                      {language === 'ms' ? 'Lihat semua pemberitahuan' : 'View all notifications'}
                    </button>
                  </div>
                </div>
              </motion.div>
