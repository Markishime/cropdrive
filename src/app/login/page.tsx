  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center py-6 xs:py-8 sm:py-12 px-3 xs:px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 relative overflow-hidden">
        ...
        <div className="max-w-md w-full space-y-4 xs:space-y-5 sm:space-y-6 relative z-10">
          <motion.div
          ...
          >
            <div className="text-center">
              ...
              <motion.h2 
                className="text-3xl xs:text-4xl font-black text-white mb-2 xs:mb-3 font-heading px-2"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
