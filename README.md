...
### 🌱 CropDrive Start - RM36/month or RM350/year
**Perfect for getting started with AI analysis**
- Analyze up to 10 reports per month
- AI-powered agronomic reports
- 1 clarification support session (WhatsApp/Email)
- Standard response time
- 5% renewal discount
- Save RM82 when you pay yearly

### ⭐ CropDrive Smart - RM47/month or RM450/year
**Most Popular - Best for active farmers**
- Analyze up to 50 reports per month
- AI-powered agronomic reports
- 3 clarification support sessions (WhatsApp/Email)
- 24-hour response time
- 10% renewal discount
- 5% referral bonus (applied to next annual plan)
- Save RM114 when you pay yearly

### 🏆 CropDrive Precision - RM65/month or RM620/year
**For serious farmers & organizations**
- Unlimited report analysis
- AI-powered agronomic reports
- Unlimited clarification support sessions
- 12-hour priority response time
- 15% renewal discount
- 10% referral bonus (applied to next annual plan)
- Year-to-year comparative analysis
- Partner discounts (test kits, fertilizers, etc.)
- Early access to new features
- Save RM160 when you pay yearly
...
- **WhatsApp**: Available for Smart and Precision plan subscribers
- **Email**: support@cropdrive.com (all plans)
- **Tutorials**: Watch step-by-step videos inside the app
- **Response Times**: 
  - Start Plan: Standard response time
  - Smart Plan: 24-hour response time
  - Precision Plan: 12-hour priority response
...
Yes! New users can try CropDrive with a free account. Contact us for more information about trial features and limitations.
...
*"Unlimited reports dengan Precision plan sangat membantu untuk ladang besar saya."*  
**- Lim Wei Ming, Sabah**

*"The comparative analysis feature shows me exactly how my farm is improving year by year."*  
**- Maria Santos, Sarawak**
...
- **Farming Tips**: Best practices for palm oil farming based on MPOB standards
- **Understanding Reports**: Learn what the numbers mean and how to interpret results
- **Success Stories**: How other farmers improved their yields by 10-30%
- **Agronomy Guides**: Expert advice on soil health and fertilizer management
- **MPOB Standards Reference**: Quick access to official Malaysian Palm Oil Board guidelines

---

## 🚀 Ready to Start?

**Visit**: [www.cropdrive.com](https://cropdrive.com)

**Get Started Today**:
1. Create your free account
2. Choose a plan that fits your needs
3. Upload your first lab report
4. Get AI-powered recommendations in 10-15 minutes

**Contact Us**:
- Email: info@cropdrive.com
- Support: support@cropdrive.com
- WhatsApp: Available for Smart and Precision plan subscribers
...
- Website: www.cropdrive.com
- Email Newsletter: Subscribe for monthly farming tips and updates
- WhatsApp Channel: Join our farming community (available for subscribers)
...
**Stripe Payment Setup**: For configuring Stripe payment processing in production mode, see [STRIPE_SETUP_GUIDE.md](STRIPE_SETUP_GUIDE.md) - includes step-by-step instructions for non-technical users.
